<?php
class ControllerExtensionMainHome extends Controller
{
    public function index(){
        ...
        $data['header'] = $this->load->controller('extension/main/header');
        $data['footer'] = $this->load->controller('extension/main/footer');


        $this->response->setOutput($this->load->view('extension/main/home', $data));
    }
